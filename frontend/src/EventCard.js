        ...
        <div className={`relative mb-6 p-2.5 rounded shadow-md h-60 bg-gray-100`}>
            ...
            <div class={`absolute rounded-b-lg inset-x-0 bottom-0 p-2.5 bg-white h-14`}>
                <div className={`grid grid-cols-3 gap-4`}>
                    <a className={`inline-block border rounded py-1 px-3 bg-indigo-900 text-white`} href={`localhost:8000/stream/${props.id}`}>
                        Stream
                    </a>
                    <a className={`inline-block border rounded py-1 px-3 bg-indigo-900 text-white`} href={`localhost:8000/timebox`}>
                        Time Auth
                    </a>
